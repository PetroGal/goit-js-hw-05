...
function getUsersWithFriend(users, friendName) {
  // users - масив об’єктів, параметр функції
  // friendName - рядок
  // getUsersWithFriend - функція повертає масив користувачів із масиву users, у яких є друг з іменем friendName
  // friends - властивість окремого об’єкту у масиві об’єктів, що передається у функцію як аргумент
